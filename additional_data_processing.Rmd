...
```{r}
path_in <- "L.zip" #this is the downloaded data of London PT services from TransXchange
gtfs <- transxchange2gtfs(path_in = path_in,
 ncores = 4)
```
! can not convert due to download failed when downloading stops data csv file. 
